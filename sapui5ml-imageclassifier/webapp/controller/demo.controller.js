...
sap.ui.define([
  ...
  /*extends string is the name of demo.view.xml controller*/
  return Controller.extend("sapui5ml.controller.demo", {
  	handleSearch:function(evt){
  		sap.m.URLHelper.redirect("http:////www.baidu.com",true);
  	},
  	handlePicture:function(evt){
  		sap.m.URLHelper.redirect("https:////unsplash.com",true);
  	},
  	handleSAP:function(evt){
  		sap.m.URLHelper.redirect("https:////www.sap.com",true);
  	},
